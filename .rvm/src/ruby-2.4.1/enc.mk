...
encsrcdir = ./enc
topdir = .
prefix = /Users/marcelnogueira/.rvm/rubies/ruby-2.4.1
exec_prefix = $(prefix)
...
DEFS = 
CPPFLAGS =  -I/usr/local/opt/libyaml/include -I/usr/local/opt/readline/include -I/usr/local/opt/libksba/include -I/usr/local/opt/openssl@1.1/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags) -DONIG_ENC_REGISTER=rb_enc_register
...
LIBPATH =  -L. -L$(topdir)
LIBS = $(LIBRUBYARG_SHARED) -lpthread -ldl -lobjc $(EXTLIBS)
...
enc/windows_31j.$(OBJEXT): enc/shift_jis.c enc/jis/props.h
